...
class LoginAndSignupPageWidget extends StatefulWidget {
  LoginAndSignupPageWidget({Key key}) : super(key: key);

  @override
  _LoginAndSignupPageWidgetState createState() =>
      _LoginAndSignupPageWidgetState();
}

class _LoginAndSignupPageWidgetState extends State<LoginAndSignupPageWidget> {
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    Padding(
                                      padding:
                                          EdgeInsets.fromLTRB(24, 24, 20, 0),
                                      child: Row(
                                        mainAxisSize: MainAxisSize.max,
                                        mainAxisAlignment:
